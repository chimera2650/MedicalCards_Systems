...
dummy_mode = 1; %0 for testing, 1 for running
...
Number_of_blocks = 20; %Total learning blocks
Number_of_DM_blocks = 10; %Number of decision blocks
Number_of_trials = 20; %Trials per block
Acc_Num = 18; %How many corrects in a block before moving to next condition
BlksCorrect = 3; %How many times in a row they must get a block correct in learning phase
...
%Resolution
%[win, rect] = Screen('OpenWindow', 0, [64 64 64], [0 0 800 600]); %Windowed
